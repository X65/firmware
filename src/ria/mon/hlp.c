...
static const char __in_flash("helptext") hlp_text_system[] =
    ...
    "they will always stop the CPU. The memory monitor commands have direct access to\n"
    "the CPU mapped RAM. The most basic is accessed by typing a hex address as a command:\n"
    "]0200\n"
...
static const char __in_flash("helptext") hlp_text_caps[] =
    ...
    "versions of BASIC. This is only in effect while 65CPU software is running.\n"
