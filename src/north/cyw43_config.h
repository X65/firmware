...
#define CYW43_DEFAULT_PIN_WL_REG_ON    34u
#define CYW43_DEFAULT_PIN_WL_CS        35u
#define CYW43_DEFAULT_PIN_WL_DATA_OUT  36u
#define CYW43_DEFAULT_PIN_WL_DATA_IN   36u
#define CYW43_DEFAULT_PIN_WL_HOST_WAKE 36u
