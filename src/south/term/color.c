...
// Indices 0-15 use the ARNE 16 palette (Arne Niklas Jansson) mapped to
// ANSI roles; 16-255 are the standard ANSI cube + grayscale ramp.
...
const uint32_t color_256[256] = {
    PICO_SCANVIDEO_PIXEL_FROM_RGB8(0, 0, 0),                                   // 0  VOID (black)
    PICO_SCANVIDEO_ALPHA_MASK | PICO_SCANVIDEO_PIXEL_FROM_RGB8(190, 38, 51),   // 1  RED (red)
    PICO_SCANVIDEO_ALPHA_MASK | PICO_SCANVIDEO_PIXEL_FROM_RGB8(68, 137, 26),   // 2  GREEN (green)
    PICO_SCANVIDEO_ALPHA_MASK | PICO_SCANVIDEO_PIXEL_FROM_RGB8(170, 157, 70),  // 3  BRASS (yellow)
    PICO_SCANVIDEO_ALPHA_MASK | PICO_SCANVIDEO_PIXEL_FROM_RGB8(0, 87, 132),    // 4  SEABLUE (blue)
    PICO_SCANVIDEO_ALPHA_MASK | PICO_SCANVIDEO_PIXEL_FROM_RGB8(164, 100, 34),  // 5  BROWN (magenta)
    PICO_SCANVIDEO_ALPHA_MASK | PICO_SCANVIDEO_PIXEL_FROM_RGB8(59, 126, 125),  // 6  TEAL (cyan)
    PICO_SCANVIDEO_ALPHA_MASK | PICO_SCANVIDEO_PIXEL_FROM_RGB8(157, 157, 157), // 7  GRAY (white)
    PICO_SCANVIDEO_ALPHA_MASK | PICO_SCANVIDEO_PIXEL_FROM_RGB8(102, 109, 112), // 8  SLATE (br black)
    PICO_SCANVIDEO_ALPHA_MASK | PICO_SCANVIDEO_PIXEL_FROM_RGB8(224, 111, 139), // 9  MEAT (br red)
    PICO_SCANVIDEO_ALPHA_MASK | PICO_SCANVIDEO_PIXEL_FROM_RGB8(163, 206, 39),  // 10 SLIMEGREEN (br green)
    PICO_SCANVIDEO_ALPHA_MASK | PICO_SCANVIDEO_PIXEL_FROM_RGB8(247, 226, 107), // 11 YELLOW (br yellow)
    PICO_SCANVIDEO_ALPHA_MASK | PICO_SCANVIDEO_PIXEL_FROM_RGB8(49, 162, 242),  // 12 SKYBLUE (br blue)
    PICO_SCANVIDEO_ALPHA_MASK | PICO_SCANVIDEO_PIXEL_FROM_RGB8(235, 137, 49),  // 13 ORANGE (br magenta)
    PICO_SCANVIDEO_ALPHA_MASK | PICO_SCANVIDEO_PIXEL_FROM_RGB8(90, 191, 166),  // 14 TURQUOISE (br cyan)
    PICO_SCANVIDEO_ALPHA_MASK | PICO_SCANVIDEO_PIXEL_FROM_RGB8(255, 255, 255), // 15 WHITE (br white)
